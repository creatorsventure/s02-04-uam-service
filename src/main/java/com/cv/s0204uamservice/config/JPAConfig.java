package com.cv.s0204uamservice.config;
...
@Configuration
@EntityScan(
        basePackages = {"com.cv.s01coreservice.entity", "com.cv.s0202uamservicepojo.entity"}
)
@EnableJpaRepositories("com.cv.s0204uamservice.repository")
